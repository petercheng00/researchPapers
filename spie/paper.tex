...
differences \cite{szeliski2006image}. Feature matching however, works best
...
Because our problem is linear, it is easily and quickly solved, and after
...
the OpenSceneGraph toolkit \cite{openscenegraph}, which allows for export to many common
model formats, as well as efficient visualization, even in web
