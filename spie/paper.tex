...
our datasets. Section \ref{sec:imageAlignment} contains our approach
...
\begin{figure}
  \centering 
  \subfloat[][]{\includegraphics[width=3in, height=0.97in]{wall2_naive.pdf}}
  \subfloat[][]{\includegraphics[width=3in, height=0.97in]{wall2_naive_shift.pdf}}

  \centering
  \subfloat[][]{\includegraphics[width=3in, height=0.97in]{wall2_cache_shift.pdf}}
  \subfloat[][]{\includegraphics[width=3in, height=0.97in]{wall2_shortest_shift.pdf}}

  \centering 
  \subfloat[][]{\includegraphics[width=3in, height=0.97in]{wall2_cache_shift_blend.pdf}}
  \subfloat[][]{\includegraphics[width=3in, height=0.97in]{wall2_shortest_shift_blend.pdf}}
...
\begin{figure}
  ...
  \caption{(a) The red lines indidcate geometry-based lines,
    consisting of boundaries and intersections. (b) A matching
    image-based line, corresponding to a corner. (c) The image rotated
    and shifted such that the matched lines align align with
    geometry.}
...
e.g. areas near point A and not near point B, in Figure \ref{fig:projectionAngles}(b).
...
\begin{figure*}
  ...
  \centering \subfloat[][]{\includegraphics[height=2in,
    width=3in]{floorcropped.jpg}} ~~~~~~~~ \centering
