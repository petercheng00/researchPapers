...
\begin{figure}[h!]
  \centering \subfloat[][]{\includegraphics[width=3in,
    height=0.9in]{wall2_naive.jpg}}

  \centering \subfloat[][]{\includegraphics[width=3in,
    height=0.9in]{wall2_cache.jpg}}

  \centering \subfloat[][]{\includegraphics[width=3in,
    height=0.9in]{wall2_cache_shift.jpg}}

  \centering \subfloat[][]{\includegraphics[width=3in,
    height=0.9in]{wall2_dynprog_noblend.jpg}}

  \centering \subfloat[][]{\includegraphics[width=3in,
    height=0.9in]{wall2_cache_shift_blend.jpg}}

  \centering \subfloat[][]{\includegraphics[width=3in,
    height=0.9in]{wall2_dynprog.jpg}}
...
features in the area are not vertical, e.g. for floors and
ceilings, this step is skipped.
...
\begin{figure}
  ...
  \centering \subfloat[][]{\includegraphics[width=3in]{4thfloor8.jpg}}
